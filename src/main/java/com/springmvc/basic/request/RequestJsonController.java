...
public class RequestJsonController {
    ...
    public String requestBodyJsonV3(HttpEntity<HelloData> data1) throws IOException {
        HelloData data = data1.getBody();
        log.info("username={}, age={}", data.getUsername(), data.getAge());
        return "ok";
    }
    ...
    public String requestBodyJsonV4(@RequestBody HelloData data) throws IOException {
        log.info("username={}, age={}", data.getUsername(), data.getAge());
        return "ok";
    }
